...
class AppAssetsSVG { 
  ...
  /// List of all assets
  static const List<String> values = [icError, icErrorClose, icInfo, icInfoClose, icSuccess, icSuccessClose, icWarning, icWarningClose, logo, onb1, onb2, onb3, onb4, sortAsc, sortDesc];
}
